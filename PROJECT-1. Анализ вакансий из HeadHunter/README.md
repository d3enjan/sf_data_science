...
Данне представлены в csv формате, cкачать нужно два файла. Файл (dst-3.0_16_1_hh_database)- это именно сам data frame, второй файл (ExchangeRates) курсы валют, потребуется для просмотра проекта. Скачать csv файлы можно по ссылке ниже.
